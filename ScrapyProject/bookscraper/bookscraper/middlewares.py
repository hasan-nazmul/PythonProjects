...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_user_agents_list(self):
        ...
        self.user_agets_list = json_response.get('result', [])

    def _get_random_user_agent(self):
        return choice(self.user_agets_list)

    def _scrapeops_fake_user_agents_enabled(self):
        if self.scrapeops_api_key or self.scrapeops_fake_user_agents_active == False:
